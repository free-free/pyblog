$(function(){
	...
	function load_user_activity_item(data)
	{
		...
		for(var i=0;i<data.length;i++)
		{
			...
			cloneActivityItem.find('.user-activity-item-identification input[name="type_id"]').val(data[i].type_id);
			cloneActivityItem.find('.user-activity-item-identification input[name="belong_id"]').val(data[i].belong_id);
