...
def main():
    ...
    parser.add_argument(
        "--port", help="queue processor listening port ", nargs=1, type=int, default=9999)
    parser.add_argument("--host", help="queue processor runining host",
                        nargs=1, type=str, default="localhost")
    parser.add_argument("--dbbuild", help="build database",
                        nargs="?", type=str, default="start", const="start")
